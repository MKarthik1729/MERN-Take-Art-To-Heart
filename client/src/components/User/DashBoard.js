    ...
    <div>
      ...
      <div className={styles.dashContent}>
        <div className="d-flex row">
          ...
          <p className={`col ${styles.conBody}`}>
            {" "}
            {props.user.username.charAt(0).toUpperCase() +
              props.user.username.slice(1)}{" "}
          </p>
        ...
        <div className="d-flex row">
          ...
          <p className={`col ${styles.conBody}`}>
            {" "}
            {props.user.usertype.charAt(0).toUpperCase() +
              props.user.usertype.slice(1)}{" "}
          </p>
        </div>
        <div className="d-flex row">
          <p className={`col ${styles.conHead}`}>Gender </p>
          <p className={`col ${styles.conBody}`}>
            {props.user.gender.charAt(0).toUpperCase() +
              props.user.gender.slice(1)}
          </p>
        </div>
        <div className="d-flex row">
          <p className={`col ${styles.conHead}`}>Country </p>
          <p className={`col ${styles.conBody}`}>
            {props.user.country.charAt(0).toUpperCase() +
              props.user.country.slice(1)}
          </p>
        </div>
        <div className="d-flex row">
